...
class BodyBreakfast extends StatelessWidget {
 List<String> bannerImage = BreakFastData.breakFastImage;
  List<String> bannerItems = BreakFastData.breakFastName;
  List<String> bannerDescription = BreakFastData.breakFastDescription;
  @override
